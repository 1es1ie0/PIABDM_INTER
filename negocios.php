        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="text-center">
                <br>
              <h1 class="text-center mt-5">Negocios</h1>
            </div>
            <h5 class="text-muted font-weight-medium mb-3">Noticias Negocios</h5>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-6  mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img src="./assets/images/negocios/noticia1.jpg" class="img-fluid" />
              <span onclick="location.href='./noticia.php'" class="thumb-title">Ver nota</span>

            </div>
            <h3 class="font-weight-600 mt-3">Bitcoin: cómo Kazajistán se convirtió en líder mundial de la criptominería</h3>
          ...
          <div class="col-lg-6  mb-5 mb-sm-2">
            <div class="row">
              ...
              <div class="col-sm-6  mb-5 mb-sm-2">
                <div class="position-relative image-hover">
                  <img src="./assets/images/negocios/noticia3.jpg"class="img-fluid"/>
                  <span onclick="location.href='./noticia.php'" class="thumb-title">Ver nota</span>

                </div>
                <h5 class="font-weight-600 mt-3">Inversiones en México podrían estar todavía lejos de niveles prepandemia</h5>
                <p class="fs-15 font-weight-normal">
                  Lorem Ipsum has been the industry's standard dummy text
                </p>
              </div>
            ...
            <div class="row mt-3">
              <div class="col-sm-6  mb-5 mb-sm-2">
                <div class="position-relative image-hover">
                  <img src="./assets/images/negocios/noticia4.jpg"class="img-fluid"/>
                  <span onclick="location.href='./noticia.php'" class="thumb-title">Ver nota</span>

                </div>
                <h5 class="font-weight-600 mt-3">La cooperativa vizcaína EIKA adquiere el 20% de la navarra Smart Confort</h5>
                <p class="fs-15 font-weight-normal">
                  Lorem Ipsum has been the industry's standard dummy text
                </p>
              </div>
              <div class="col-sm-6">
                <div class="position-relative image-hover">
                  <img src="./assets/images/negocios/noticia5.jpg"class="img-fluid"/>
                  <span onclick="location.href='./noticia.php'" class="thumb-title">Ver nota</span>

                </div>
                <h5 class="font-weight-600 mt-3">La economía mundial en 2022: crecimiento en un estanque lleno de pirañas</h5>
                <p class="fs-15 font-weight-normal">
                  Lorem Ipsum has been the industry's standard dummy text
                </p>
              </div>
