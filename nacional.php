      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
            <div class="text-center">
                <br>
              <h1 class="text-center mt-5">Nacional</h1>
            </div>
            <h5 class="text-muted font-weight-medium mb-3">Noticias Nacionales</h5>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-6  mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img src="./assets/images/nacional/noticia1.jpg" class="img-fluid" />
          ...
          <div class="col-lg-6  mb-5 mb-sm-2">
            <div class="row">
              ...
              <div class="col-sm-6  mb-5 mb-sm-2">
                <div class="position-relative image-hover">
                  <img src="./assets/images/nacional/noticia3.jpg"class="img-fluid"/>
                  <span onclick="location.href='./noticia.php'" class="thumb-title">Ver nota</span>
            ...
            <div class="row mt-3">
              <div class="col-sm-6  mb-5 mb-sm-2">
                <div class="position-relative image-hover">
                  <img src="./assets/images/nacional/noticia4.jpg"class="img-fluid"/>
                  <span onclick="location.href='./noticia.php'" class="thumb-title">Ver nota</span>

                </div>
                <h5 class="font-weight-600 mt-3">La Justicia frena la construcción del mayor puerto de México para proteger los arrecifes</h5>
                <p class="fs-15 font-weight-normal">
                  Lorem Ipsum has been the industry's standard dummy text
                </p>
              </div>
              <div class="col-sm-6">
                <div class="position-relative image-hover">
                  <img src="./assets/images/nacional/noticia5.jpg"class="img-fluid"/>
                  <span onclick="location.href='./noticia.php'" class="thumb-title">Ver nota</span>

                </div>
                <h5 class="font-weight-600 mt-3">Morena en el Senado prepara cambios a la reforma eléctrica para evitar fricciones con el T-MEC</h5>
                <p class="fs-15 font-weight-normal">
                  Lorem Ipsum has been the industry's standard dummy text
                </p>
              </div>
        ...
        <div class="row mb-4">
          <div class="col-sm-3  mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img src="./assets/images/ejemplos/mexico.jpg"class="img-fluid"/>
              <span onclick="location.href='./noticia.php'" class="thumb-title">Ver nota</span>
