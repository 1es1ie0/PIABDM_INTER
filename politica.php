        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="text-center">
                <br>
              <h1 class="text-center mt-5">Politica</h1>
            </div>
            <h5 class="text-muted font-weight-medium mb-3">Noticias Politica</h5>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-6  mb-5 mb-sm-2">
            ...
            <h3 class="font-weight-600 mt-3">Ataques de AMLO a prensa son irresponsabilidad política: Artículo 19 sobre Loret de Mola</h3>
          ...
          <div class="col-lg-6  mb-5 mb-sm-2">
            <div class="row">
              <div class="col-sm-6  mb-5 mb-sm-2">
                <div class="position-relative image-hover">
                  <img src="./assets/images/politica/noticia2.jpg"class="img-fluid"/>
                  <span onclick="location.href='./noticia.php'" class="thumb-title">Ver nota</span>

                </div>
                <h5 class="font-weight-600 mt-3">Igea pide cerrar la pauerta a la politica de la deshonestidad</h5>
                <p class="fs-15 font-weight-normal">
              ...
              <div class="col-sm-6  mb-5 mb-sm-2">
                <div class="position-relative image-hover">
                  <img src="./assets/images/politica/noticia3.jpg"class="img-fluid"/>
                  <span onclick="location.href='./noticia.php'" class="thumb-title">Ver nota</span>

                </div>
                <h5 class="font-weight-600 mt-3">Iniciarán intercampañas, permiten propaganda política informativa</h5>
                <p class="fs-15 font-weight-normal">
                  Lorem Ipsum has been the industry's standard dummy text
                </p>
              </div>
            ...
            <div class="row mt-3">
              <div class="col-sm-6  mb-5 mb-sm-2">
                <div class="position-relative image-hover">
                  <img src="./assets/images/politica/noticia4.jpg"class="img-fluid"/>
                  <span onclick="location.href='./noticia.php'" class="thumb-title">Ver nota</span>

                </div>
                <h5 class="font-weight-600 mt-3">México y España: qué quiso decir AMLO con la idea de "pausar" las relaciones entre ambos países</h5>
                <p class="fs-15 font-weight-normal">
                  Lorem Ipsum has been the industry's standard dummy text
                </p>
              </div>
              <div class="col-sm-6">
                <div class="position-relative image-hover">
                  <img src="./assets/images/politica/noticia5.jpg"class="img-fluid"/>
                  <span onclick="location.href='./noticia.php'" class="thumb-title">Ver nota</span>

                </div>
                <h5 class="font-weight-600 mt-3">La relación entre California y China es el experimento diplomático más grande entre superpoderes</h5>
                <p class="fs-15 font-weight-normal">
                  Lorem Ipsum has been the industry's standard dummy text
                </p>
              </div>
